...
class ObjetManager{
	...
	$bdd = Database::getInstance();
        ...
        $req =$bdd->prepare("INSERT INTO articles SET id_membre = :membre , id_cat_art = :choix, nom = :nom, description = :description, etat = :etat, prix = :prix, prix_en_cours = :prix_en_cours, datefin = :datefin");	   
        ...
        $req->bindValue(':prix_en_cours', $objet->getPrix(),PDO::PARAM_INT);		
